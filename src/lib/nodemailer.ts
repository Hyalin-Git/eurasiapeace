    ...
    colors.white
            ...
            <div style="position: relative; z-index: 2;">
              ...
              <div style="margin-bottom: 20px;">
                ...
                <a href="https://x.com/eurasia_peace" target="_blank" style="display: inline-block; margin-right: 10px;">
                ...
                <a href="https://fr.linkedin.com/company/eurasiapeace" target="_blank" style="display: inline-block; margin-right: 10px;">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="${
                    colors.white
                  }">
                ...
                <a href="https://www.facebook.com/p/EurasiaPeace-100077017295602/" target="_blank" style="display: inline-block; margin-right: 10px;">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="${
                    colors.white
                  }">
                ...
                <a href="https://www.instagram.com/eurasiapeace/" target="_blank" style="display: inline-block; margin-right: 15px;">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="${
                    colors.white
                  }">
