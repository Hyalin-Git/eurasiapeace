export function resendVerificationEmailTemplate(
  verificationCode: string,
  clientUrl: string
) {
  return {
    subject: "📧 Confirmez votre adresse e-mail - Eurasia Peace",
    text: `
      <div style="max-width: 800px; margin: 0 auto; font-family: Arial, sans-serif; line-height: 1.5; color: #333; font-size: 16px;">
        <div style="padding: 25px; background: #f9f9f9;">
          <div style="background: white; padding: 22px; border-radius: 8px; margin-bottom: 18px;">
            <h2 style="color: #0066cc; margin-top: 0; font-size: 20px;">Confirmez votre adresse e-mail</h2>
            <p style="font-size: 15px;">Bonjour,</p>
            <p style="font-size: 15px;">Merci de vous être inscrit sur Eurasia Peace. Pour finaliser votre inscription, veuillez confirmer votre adresse e-mail en cliquant sur le bouton ci-dessous :</p>
