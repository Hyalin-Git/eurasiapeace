      ...
      <div className="w-full bg-gradient-to-r from-background-dark-blue to-background-light-blue rounded-none px-4 py-5 flex items-center justify-center shadow-md border-b border-white/20 backdrop-blur-sm">
        <div className="flex items-center justify-between w-full container mx-auto gap-8">
          <div className="flex items-center gap-4">
            ...
            <span className="text-white font-semibold text-sm lg:text-lg leading-tight">
              {title}
            </span>
          </div>

          <div className="flex flex-col items-end">
            <span className="text-white/80 text-sm lg:text-md mb-1">
              Notre équipe éditoriale vous accompagne
            </span>

            <Link
              href={href}
              className="text-white font-bold px-6 py-2  text-sm lg:text-md rounded-lg bg-white/10 hover:bg-white/20 transition-colors shadow"
            >
              {isSubscription ? "Abonnez-vous" : "Contactez-nous"} dès
              maintenant !
            </Link>
          </div>
        </div>
