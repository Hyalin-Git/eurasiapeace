...
export default function Abonnements() {
  return (
    <main>
      <div className="container min-h-screen bg-gray-50 py-12">
        ...
        <div className="max-w-3xl mx-auto mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <p className="text-blue-700 text-sm">
            L&apos;abonnement Contributeur Spécial est strictement encadré par
            un contrat d&apos;engagement réciproque. Il est mensuel et peut être
            résilié à tout moment. La candidature est soumise à l&apos;accord du
            fondateur suite à un processus de sélection préalable et un
            entretien.
          </p>
        </div>
      </div>
